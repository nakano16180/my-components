...
import { McpUiPage } from "@/app/mcp-ui/page"
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export default function Page() {
  const [activeView, setActiveView] = useState<"dashboard" | "chart" | "widgets" | "mcp-ui">("dashboard")
          ...
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem className="hidden md:block">
                <BreadcrumbLink href="#">
                  {activeView === "dashboard" ? "Building Your Application" : activeView === "chart" ? "Demos" : activeView === "widgets" ? "Wigggle UI" : "Docs"}
                </BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator className="hidden md:block" />
              <BreadcrumbItem>
                <BreadcrumbPage>
                  {activeView === "dashboard" ? "Data Fetching" : activeView === "chart" ? "Chart Demo" : activeView === "widgets" ? "Widgets" : "MCP-UI"}
                </BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
